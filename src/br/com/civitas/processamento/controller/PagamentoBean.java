...
public class PagamentoBean extends AbstractCrudBean<Pagamento, PagamentoService> implements Serializable {
	...
	private static final int MAXIMO_EVENTOS_PERMITIDOS = 244;
	...
	private boolean maximoEventosPermitidos() {
		return Objects.nonNull(eventosSelecionados) && eventosSelecionados.size() < MAXIMO_EVENTOS_PERMITIDOS;
	}
